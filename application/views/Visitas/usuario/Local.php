...
<div class="trasparente ">
 ...
 <center>
    <div class="locales parallax2">
        <h4>Categorias</h4>
    <a href="<?php echo ruta; ?>Usuarios/Locales/1" class="badge badge-dark"><h4>Comida</h4></a>
    <a href="<?php echo ruta; ?>Usuarios/Locales/2" class="badge badge-dark"><h4>Ropa</h4></a>
    <a href="<?php echo ruta; ?>Usuarios/Locales/3" class="badge badge-dark"><h4>Zapatos</h4></a>
    <a href="<?php echo ruta; ?>Usuarios/Locales/4" class="badge badge-dark"><h4>Turismo</h4></a>
<br><br><br>
<h4>Tags</h4>
    ...
    <?php if ($tags) : ?>
        ...
        ?>
               <a href="<?php echo ruta; ?>Usuarios/Locales/1" class="badge badge-dark"><h6><?= $worker->tag; ?></h6   ></a>
            ...
            <div class="col-md-6">
                <div class="card flex-md-row mb-5 box-shadow h-md-250">
                    <div class="card-body d-flex flex-column align-items-start">
                        ...
                        <a href="<?php echo ruta; ?>Usuarios/Detallelocal/<?= $worker->id?>">Ver mas</a>
                    </div>
